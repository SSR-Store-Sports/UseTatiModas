...
@section('content')
    <main class="h-full">
        <div class="rounded-sm border-b-4 border-t-8 border-pink-600 shadow-sm shadow-pink-500/50">
        ...
        <section class="flex flex-col px-24 mt-12 gap-8">
            <div class="flex flex-col gap-2 justify-center shadow-[0_8px_4px_-4px_rgba(236,72,153,0.4)]">
                <label class="flex px-16 items-center gap-2">
                    <x-heroicon-o-shopping-bag class="h-8 w-8 text-pink-600 drop-shadow-[0_2px_4px_rgba(236,72,153,0.6)]" />
            ...
            <div class="flex flex-col gap-8 items-center">
                <div class="grid grid-cols-4 gap-8 justify-center items-center">
                    @for ($i = 0; $i < 4; $i++)
                        <div
                            class="flex flex-col w-full bg-white shadow-pink-500/90 rounded-lg gap-2 hover:shadow-xl/50 shadow-xl/30 cursor-pointer inset-shadow-xs transition-all duration-200">
        ...
        <section class="flex flex-col px-24 mt-12 mb-12 gap-8">
            <div class="flex flex-col gap-2 justify-center shadow-[0_8px_4px_-4px_rgba(236,72,153,0.4)]">
                <label class="flex px-16 items-center gap-2">
                    <x-heroicon-o-shopping-bag class="h-8 w-8 text-pink-600 drop-shadow-[0_2px_4px_rgba(236,72,153,0.6)]" />
                    <h1 class="text-pink-600 text-4xl drop-shadow-[0_2px_4px_rgba(236,72,153,0.6)]">PARA VOCÊ
                    </h1>
                </label>
                <span class="w-full h-0.5 bg-pink-600"></span>
            </div>
