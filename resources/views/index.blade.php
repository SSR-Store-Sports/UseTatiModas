...
@section('content')
    <main class="h-full">
        ...
        <section class="flex flex-col px-24 mt-12 gap-8">
            <div class="flex flex-col gap-2 justify-center shadow-[0_8px_4px_-4px_rgba(236,72,153,0.4)]">
                <label class="flex px-16 items-center gap-2">
                    ...
                    <h1 class="text-pink-600 text-4xl drop-shadow-[0_2px_4px_rgba(236,72,153,0.6)]">PRODUTOS EM DESTAQUE</h1>
                </label>
                        ...
                        <div class="flex flex-col w-full bg-white shadow-pink-500/90 rounded-lg gap-2 hover:shadow-xl/50 shadow-xl/30 hover:cursor-pointer inset-shadow-xs transition-all duration-200">
                            ...
                            <div class="flex flex-col gap-4 justify-center px-4 py-4">
                                ...
                                <div class="flex flex-col gap-2">
                                    <button class="group bg-pink-500 text-white flex items-center justify-center rounded-sm w-full pt-3 pb-3 gap-2 border-2 border-transparent hover:bg-white hover:border-2 hover:border-pink-600 hover:text-pink-600 cursor-pointer text-center outline-none transition-all duration-200">
                                        <span>Comprar</span>
                                        <x-heroicon-o-shopping-cart class="h-4 w-4" />
                                    </button>
                                    <button class="group bg-white text-pink-600 flex items-center justify-center rounded-sm w-full pt-3 pb-3 gap-2 border-2 border-pink-600 hover:bg-gray-100 hover:border-2 hover:border-pink-700 hover:text-pink-700 cursor-pointer text-center outline-none transition-all duration-200">
                                        <span>Carrinho</span>
        ...
        <section class="flex flex-col px-24 mt-12 mb-12 gap-8">
            <div class="flex flex-col gap-2 justify-center shadow-[0_8px_4px_-4px_rgba(236,72,153,0.4)]">
                <label class="flex px-16 items-center gap-2">
                    <x-heroicon-o-building-storefront class="h-8 w-8 text-pink-600 drop-shadow-[0_2px_4px_rgba(236,72,153,0.6)]" />
            ...
            <div class="grid grid-cols-8 gap-8 mx-16">
                @for($i = 0; $i < 8; $i++)
                    <a href="/parceiros/zara" class="group flex flex-col items-center gap-2 cursor-pointer">
                        <div class="w-20 h-20 rounded-full border-2 border-pink-300 bg-pink-50 flex items-center justify-center shadow-md shadow-pink-500/30 transition-all duration-200 group-hover:border-pink-600 group-hover:shadow-pink-500/60 group-hover:scale-105">
                            <x-heroicon-o-academic-cap class="h-10 w-10 text-pink-500 group-hover:text-pink-600" />
                        </div>
                        <span class="text-xs text-gray-600 group-hover:text-pink-600 transition-colors duration-200 font-medium">Zara</span>
                    </a>
                @endfor
            </div>
        </section>
                    ...
                    <div class="relative flex flex-row rounded-xl h-40 overflow-hidden shadow-lg shadow-pink-500/30 bg-white">
                        <div class="flex flex-col gap-3 justify-center px-6 py-4 flex-1">
                            <div class="flex flex-col gap-1">
                                <h3 class="text-pink-500 text-xl font-semibold tracking-wide drop-shadow-[0_2px_4px_rgba(236,72,153,0.4)]">
                                    PRODUTOS ESSENCIAIS
                                </h3>
                            ...
                            <button class="group bg-pink-500 text-white flex items-center justify-center rounded-md w-full py-2 gap-2 border-2 border-transparent hover:bg-white hover:border-pink-600 hover:text-pink-600 cursor-pointer outline-none transition-all duration-200 text-sm">
                                <span>Conferir</span>
                                <x-heroicon-o-arrow-right class="h-3.5 w-3.5" />
                            </button>
                        </div>
                        <div class="relative w-8 shrink-0">
                            <svg class="absolute inset-0 h-full w-full" viewBox="0 0 32 160" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="grid grid-cols-4 gap-8 justify-center items-center">
                    @for ($i = 0; $i < 15; $i++)
                        <div class="flex flex-col w-full bg-white shadow-pink-500/90 rounded-lg gap-2 hover:shadow-xl/50 shadow-xl/30 hover:cursor-pointer inset-shadow-xs transition-all duration-200">
                            ...
                            <div class="flex flex-col gap-4 justify-center px-4 py-4">
                                <div class="flex flex-col">
                                    <label class="text-black text-left px-2 text-lg font-bold line-clamp-1">NC roupa feminina top de linha ultra fina</label>
                                    <label class="text-gray-600 text-left px-2 text-sm line-clamp-2">Peça de roupa exclusiva com duplo preenchimento e reforço em</label>
        ...
        <section class="flex flex-col px-24 mt-12 mb-12 gap-8">
            <div class="flex flex-col gap-2 justify-center shadow-[0_8px_4px_-4px_rgba(236,72,153,0.4)]">
                <label class="flex px-16 items-center gap-2">
                    <x-heroicon-o-chat-bubble-left-right class="h-8 w-8 text-pink-600 drop-shadow-[0_2px_4px_rgba(236,72,153,0.6)]" />
                    <h1 class="text-pink-600 text-4xl drop-shadow-[0_2px_4px_rgba(236,72,153,0.6)]">O QUE FALAM DA GENTE</h1>
                </label>
                <span class="w-full h-0.5 bg-pink-600"></span>
            </div>
            ...
            <div class="grid grid-cols-2 gap-8 mx-16">
                @for($i = 0; $i < 4; $i++)
                    <div class="relative flex flex-col rounded-xl overflow-hidden shadow-lg shadow-pink-500/30 bg-white p-6 gap-4">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed line-clamp-3">
                            Amei os produtos! A qualidade é incrível e o atendimento foi super rápido. Com certeza vou comprar novamente.
                        </p>
                        <div class="flex flex-row gap-2 items-center">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-pink-100 border-2 border-pink-300 flex items-center justify-center shrink-0">
