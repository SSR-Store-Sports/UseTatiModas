...
@section('content')
    <main class="h-full">
        ...
        <div class="mt-8 rounded-sm border-b-4 border-t-8 border-pink-600">
            <img src="{{ asset('assets/banner.png') }}" class="h-138 w-full" alt="Logo">
        </div>
        ...
        <section class="flex flex-col px-24 mt-12 gap-8">
            ...
            <div class="flex gap-8">
                <div class="flex flex-col mx-24 bg-white shadow-black rounded-sm gap-2">
                    <div class="flex justify-center items-center gap-2">
                        <img src="border-2-pink-500" alt="">
                    ...
                    <div>
                        <label class="text-pink-600">NC roupa feminina...</label>
