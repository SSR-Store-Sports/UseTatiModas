...
@section('title', 'Nova Categoria: UseTatiModas Admin')
    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <h1 class="text-2xl md:text-3xl font-bold tracking-tight text-gray-800">Nova Categoria</h1>
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-4">
                        ...
                        <div class="rounded-md border border-gray-200 bg-white p-6 flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Ex: Moda Feminina"
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug') }}" placeholder="Ex: moda-feminina"
                                    class="px-4 py-2 rounded-md border border-gray-200 bg-gray-50 text-gray-800 placeholder-gray-400 text-sm outline-none transition-all duration-200 hover:border-[#F1C24A] hover:bg-white focus:border-[#C79B2B] focus:bg-white focus:ring-2 focus:ring-[#C79B2B]/20">
                                <span class="text-xs text-gray-400">Gerado automaticamente a partir do nome</span>
