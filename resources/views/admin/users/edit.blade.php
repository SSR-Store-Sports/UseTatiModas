...
@section('title', 'Editar Usuário: UseTatiModas Admin')
    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <h1 class="text-2xl md:text-3xl font-bold tracking-tight text-gray-800">Editar Usuário</h1>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-4">
                        ...
                        <div class="rounded-md border border-gray-200 bg-white p-6 flex flex-col gap-4">
                            <h2 class="text-base font-semibold text-gray-800 border-b border-gray-100 pb-3">Informações do Usuário</h2>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="email" name="email" value="{{ old('email', $user->email) }}" placeholder="Ex: joao@exemplo.com"
                                    class="px-4 py-2 rounded-md border border-gray-200 bg-gray-50 text-gray-800 placeholder-gray-400 text-sm outline-none transition-all duration-200 hover:border-[#F1C24A] hover:bg-white focus:border-[#C79B2B] focus:bg-white focus:ring-2 focus:ring-[#C79B2B]/20">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="rounded-md border border-gray-200 bg-white p-6 flex flex-col gap-4">
                            <h2 class="text-base font-semibold text-gray-800 border-b border-gray-100 pb-3">Permissões</h2>

                            <div class="flex flex-col gap-2">
                                <label class="text-sm font-medium text-gray-700">Função <span class="text-red-500">*</span></label>
                                <select name="role"
