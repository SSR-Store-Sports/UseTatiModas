      ...
      <div class="flex flex-col gap-4">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div class="flex gap-2">
            ...
            <button
              class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gold-dark transition-colors text-sm font-medium flex items-center gap-2">
        ...
        <div class="space-y-2.5">
          <div class="flex flex-col sm:flex-row gap-2">
            ...
            <select
              class="px-4 py-2 rounded-md border border-gray-200 bg-gray-50 text-gray-800 text-sm outline-none transition-all duration-200 hover:border-[#F1C24A] hover:bg-white focus:border-gold-medium focus:bg-white focus:ring-2 focus:ring-[#C79B2B]/20">
            ...
            <button
              class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gold-dark transition-colors text-sm font-medium">
          ...
          <div class="flex items-center gap-2 p-3 bg-gray-50 rounded-md border border-gray-200">
            ...
            <div class="flex gap-2 ml-auto">
              <button
                class="px-3 py-1.5 bg-blue-500 text-white rounded-md hover:bg-blue-600 transition-colors text-xs font-medium flex items-center gap-1">
                <x-heroicon-o-check-circle class="w-4 h-4" />
                Ativar selecionados
              </button>
              <button
                class="px-3 py-1.5 bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors text-xs font-medium flex items-center gap-1">
                    ...
                    <tr class="hover:bg-gray-100/40 transition-colors">
                      ...
                      <td class="px-4 py-4">
                        <select class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border-0 outline-none cursor-pointer
                            ...
                            @endif">
                          <option value="active" {{ ($supplier->status ?? 'active') == 'active' ? 'selected' : '' }}>Ativo
                          </option>
                          <option value="inactive" {{ ($supplier->status ?? 'active') == 'inactive' ? 'selected' : '' }}>
                            Inativo</option>
                        </select>
                      </td>
