        ...
        <section class="bg-white rounded-xl shadow-lg shadow-pink-500/20 p-10 flex gap-12">
            ...
            <div class="flex flex-col gap-6 flex-1">
                ...
                <div class="flex gap-4 mt-4">
                    <button
                        class="group bg-pink-500 text-white px-6 py-3 rounded-md flex items-center gap-2 border-2 border-transparent hover:bg-white hover:text-pink-600 hover:border-pink-600 transition-all duration-200">
                        <span>Adicionar ao Carrinho</span>
                        <x-heroicon-o-plus-circle class="h-5 w-5" />
                    </button>

                    <button
                        class="group bg-white text-pink-600 px-6 py-3 rounded-md flex items-center gap-2 border-2 border-pink-600 hover:bg-pink-50 hover:text-pink-700 hover:border-pink-700 transition-all duration-200">
                        <span>Comprar</span>
            ...
            <div class="grid grid-cols-4 gap-8">
                ...
                @for ($i = 0; $i < 4; $i++)
                    <div
                        ...
                        <button
                            class="w-full bg-pink-500 text-white py-2 rounded-md border-2 border-transparent hover:bg-white hover:text-pink-600 hover:border-pink-600 transition-all duration-200 text-sm">
                            Comprar
                        </button>
