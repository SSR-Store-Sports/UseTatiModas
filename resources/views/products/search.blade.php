        ...
        <div class="space-y-4 md:space-y-6">
          <div>
            ...
            <div class="space-y-2">
              ...
              <select
                class="w-full text-xs md:text-sm p-2 border border-gray-200 rounded-sm text-gray-600 focus:border-pink-500 outline-none">
          ...
          <div class="border-t border-gray-200 pt-4 md:pt-6">
            ...
            <div class="space-y-2">
              <a href="#" class="block text-xs md:text-sm text-gray-600 hover:text-pink-600">@lang('category_item1')</a>
              <a href="#" class="block text-xs md:text-sm text-gray-600 hover:text-pink-600">@lang('category_item2')</a>
            </div>
          </div>
        </div>
      </aside>
      ...
      <main class="flex-1">
        <div
          ...
          <span class="text-sm md:text-md text-gray-600">@lang('search_result') <span
              class="font-bold text-pink-600">'Calças'</span></span>

          <div class="flex items-center gap-2">
            <span class="text-xs md:text-sm text-gray-500">@lang('sort_by'):</span>
            <button class="text-xs md:text-sm font-semibold text-gray-800 hover:text-pink-600">@lang('relevance')</button>
            <button class="text-xs md:text-sm font-semibold text-gray-500 hover:text-pink-600">@lang('newest')</button>
          </div>
        </div>
        ...
        <div class="flex flex-wrap gap-2 mb-8 md:mb-12 justify-center">
          <button
            class="group text-white bg-pink-600 flex items-center justify-center rounded-sm h-10 md:h-12 px-3 md:px-4 gap-2 border-2 border-pink-600 hover:bg-gray-100 hover:border-2 hover:border-pink-700 hover:text-pink-700 cursor-pointer text-center outline-none transition-all duration-200 text-xs md:text-sm"
            disabled>
            <span>@lang('previous')</span>
          </button>
          <button
            class="group bg-pink-300 text-white flex items-center justify-center rounded-sm h-10 md:h-12 px-3 md:px-4 gap-2 border-2 border-pink-300 hover:bg-gray-100 hover:border-2 hover:border-pink-700 hover:text-pink-700 cursor-pointer text-center outline-none transition-all duration-200 text-xs md:text-sm">
            <span>1</span>
          </button>
          <button
            class="group bg-white text-pink-600 flex items-center justify-center rounded-sm h-10 md:h-12 px-3 md:px-4 gap-2 border-2 border-pink-600 hover:bg-gray-100 hover:border-2 hover:border-pink-700 hover:text-pink-700 cursor-pointer text-center outline-none transition-all duration-200 text-xs md:text-sm">
            <span>2</span>
          </button>
          <button
            class="group bg-white text-pink-600 flex items-center justify-center rounded-sm h-10 md:h-12 px-3 md:px-4 gap-2 border-2 border-pink-600 hover:bg-gray-100 hover:border-2 hover:border-pink-700 hover:text-pink-700 cursor-pointer text-center outline-none transition-all duration-200 text-xs md:text-sm">
