      ...
      @if($payment === 'pix')
        <div class="flex flex-col items-center gap-4">
          ...
          <div class="p-3 border-2 border-gold-medium rounded-xl bg-white">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data={{ urlencode('00020126580014br.gov.bcb.pix0136contato@tatifitwear.com.br5204000053039865802BR5925UseTatiModas6009SAO PAULO62070503***6304') }}"
          ...
          <div class="w-full flex flex-col gap-2">
            ...
            <div class="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg p-3">
              <span id="pix-key" class="flex-1 text-sm text-gray-800 font-mono break-all">contato@tatifitwear.com.br</span>
