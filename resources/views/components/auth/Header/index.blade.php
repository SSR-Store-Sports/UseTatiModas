<header
    ...
    <nav class="flex gap-2 justify-center items-center shrink-0">
        <a href="/cart"
            class="bg-gold-medium text-white rounded-sm p-2 border-2 border-gold-mediumhover:bg-white hover:bg-gold-dark hover:border-2 hover:text-white transition-all duration-200">
