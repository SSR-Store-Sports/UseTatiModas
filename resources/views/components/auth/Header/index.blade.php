<header class="z-50 grid grid-cols-[auto_1fr_auto] gap-2 md:gap-8 items-center h-auto md:h-28 px-4 md:px-18 py-4 md:py-0 border-b-2 border-gold-light overflow-x-hidden shrink-0">
