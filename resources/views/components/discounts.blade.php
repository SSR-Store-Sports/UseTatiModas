<section class="flex flex-col items-center justify-center gap-6 bg-[#C79B2B] border-t border-b border-[#7A5A12]/20 py-12 px-4 shadow-sm">
    ...
    <div class="grid md:flex gap-2 w-full max-w-md">
        ...
        <button
            class="bg-white text-[#7A5A12] font-semibold px-6 py-3 rounded-md border-2 border-white hover:bg-[#7A5A12] hover:text-white transition-all duration-200 cursor-pointer outline-none whitespace-nowrap">
            @lang('want_discount')
        </button>
    </div>
</section>